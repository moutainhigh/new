...
<div class="portlet light" >
    <div class="portlet-title">
        <div style="width: 99%;text-align: center;"> <h1>营销费用发生登录</h1> </div>
    </div>
    <div class="portlet-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label>费用归属年月：</label>
                <span class="form-group"><input readonly type="text" class="form-control" value="${marketCostContract.affiliationDate}" ></span>
            </div>
        </div>
        <label></label>
        <div class="row">
            <table data-toggle="table" data-height="250" class="table table-width table-striped table-bordered table-advance">
                ...
                <tbody>
                    <c:forEach items="${marketCostContract.marketCostApplyRepairDetailList}" var="e" varStatus="varstatus">
                        <tr>
