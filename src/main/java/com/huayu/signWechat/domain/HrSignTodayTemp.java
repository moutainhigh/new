...
/**
* Created by DengPeng on 2017-9-21 9:50:09.
*/
@Table(name = "hr_sign_today_temp")
public class HrSignTodayTemp extends BaseDomain  implements Serializable{

 //private String updateFiledKey = id,userid,username,telephone,groupname,checkin_type,exception_type,checkin_time,location_title,location_detail,wifiname,notes,wifimac,mediaids,updateTime,updateUser;
 //private String updateFiledValue = id=:id,userid=:userid,username=:username,telephone=:telephone,groupname=:groupname,checkin_type=:checkin_type,exception_type=:exception_type,checkin_time=:checkin_time,location_title=:location_title,location_detail=:location_detail,wifiname=:wifiname,notes=:notes,wifimac=:wifimac,mediaids=:mediaids,updateTime=:updateTime,updateUser=:updateUser;
    private Integer id;
