                            ...
                            <div class="col-md-4 ">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type">
                                        <option value="0" <c:if test="${entity.type eq 0}">selected</c:if>>公休加班</option>
                                        <option value="2" <c:if test="${entity.type eq 2}">selected</c:if>>普通加班</option>
                                        <option value="3" <c:if test="${entity.type eq 3}">selected</c:if>>节日加班</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 ">
...
//                _index = layer.load(2);
                $.post('<c:url value="/hr/atte/postOvertimeEdit"/>', dataObj, function (result) {
                    if (result.success) {
                        layer.close(_index);
