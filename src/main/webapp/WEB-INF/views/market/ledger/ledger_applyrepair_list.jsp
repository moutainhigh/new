...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<c:url value="/market/ledger/applyrepairlist" />">发生登记台账</a>
            <i class="fa fa-angle-right"></i>
        </li>
    </ul>
</div>
...
<div class="portlet light" id="form_wizard_1">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green sbold uppercase">营销费用发生登记台账</span>
       	</div>
        <div class="actions">
            <label>经办日期：</label>
            ...
            <input id="id_s1" class="form-control input-inline input-sm" style="width: 150px;" type="text" value="${entity.s1}" placeholder="主题" autocomplete="off" />
    ...
    <div class="portlet-body">
            ...
            <tbody>
                <c:forEach items="${page.content}" var="e" varStatus="status">
                    <tr>
                        ...
                        <td>${e.affiliationDate}</td>
                        <td>
                            <a class="btn btn-xs grey-cascade" href="javascript:marketLedger('<c:url value="/market/contract/payrepairledger/"/>${e.payId}');" data-url="<c:url value="/market/contract/payrepairledger/"/>${e.contractId}"><i class="fa fa-file-text-o"></i> 详情 </a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
        ...
        <div class="row">
	    	<div class="col-md-5 col-sm-5">
	    		<ly:pageSizeTag link="/market/ledger/applyrepairlist${ly:toString(entity,'s1,i1,d3,d4,dt,dtn')}" page="${page}"></ly:pageSizeTag>
	    	</div>
	    	<div class="col-md-7 col-sm-7 text-right">
                <ly:pageTag link="/market/ledger/applyrepairlist${ly:toString(entity,'s1,i1,d3,d4,dt,dtn')}&pageNo=" page="${page}"></ly:pageTag>
	    	</div>
    	</div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function search() {
        window.location.href = "<c:url value="/market/ledger/applyrepairlist"/>"+ "${ly:toString(entity,'pageSize,dt,dtn')}"+"&s1="+$("#id_s1").val()+"&d3="+$("#id_d3").val()+"&d4="+$("#id_d4").val();
    }
