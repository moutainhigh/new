...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green sbold uppercase">仓库列表</span>
        </div>
        <div class="actions form-inline">
            <a href="<c:url value="/admin/inventory/storage/edit"/>"><button class="btn blue"><i class="fa fa-plus-circle"></i>新增</button></a>
        </div>
    </div>
...
$(function () {
            ...
            var  e = function() {
                ...
                table.init({
                    ...
                    dataTable: {
                        ...
                        pageLength: 10,
                        ajax: {
                            url: "<c:url value="/admin/inventory/storage/repositoryListData"/>"
                        },
                        order: [[1, "asc"]],
                        columns:[
                            {"data":"id", "targets": 0},
                            ...
                            {"data":"rcode","render" : function(data, type, full, meta ){
                                return data==undefined?'':data;
                            }},
                            ...
                            {"data":"id","render" : function(data, type, full, meta ){
                                var editUrl = "<c:url value='/admin/inventory/storage/edit/'/>"+data;
        ...
        $('#datatable_ajax').on('click','button',function () {
            ...
            layer.confirm("确定要删除该仓库？",function (_index) {
                layer.close(_index);
                $.post('<c:url value="/admin/inventory/storage/delete"/>', {id:_id}, function (result) {
                    if (result.success) {
