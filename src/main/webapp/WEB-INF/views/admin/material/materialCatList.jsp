    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  role="form" class="js_base_form" id="catEditForm" method="post" action="<c:url value="/admin/materialCategory/update"/>">
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  role="form" class="js_base_form" id="catAddForm" method="post" action="<c:url value="/admin/materialCategory/create"/>">
...
<script>
    ...
    $(function () {
        ...
        $('a.dodel').click(function () {
            ...
            if (node && node.data('leaf') === 1){
                layer.confirm('你确定要删除吗？', {
                    ...
                    layer.close(_index);
                    $.post("/admin/materialCategory/delete",{"id":id,"parentId":pid},function (data) {
                        if (data.success){
        ...
        $("#addModal").on('click',"button:eq(1)",function () {
            $.post("/admin/materialCategory/create",$("#addModal").find('form').serialize(),function (data) {
                if(data.success){
                    $('#addModal').modal('hide');
