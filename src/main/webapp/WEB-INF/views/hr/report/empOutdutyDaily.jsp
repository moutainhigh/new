        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">离职情况</span>
                </div>
                <div class="actions">
                    <div class="btn-group btn-group-devided" >
                        <a href="<c:url value="/hr/reports/empIndutyDaily"/>"  class="btn btn-transparent blue btn-outline btn-circle btn-sm">入职情况</a>
                        <a href="<c:url value="/hr/reports/empOutdutyDaily"/>"  class="btn btn-transparent blue btn-outline btn-circle btn-sm active green">离职情况</a>
    ...
    $(document).ready(function () {
        ...
        $('button.js_search').on('click',function () {
            ...
            build(args,function (data) {
                ...
                $(data.outDuty).each(function (k, v) {
                    var _tr = $('<tr>');
