        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">人力资源盘点（管理类）</span>
                </div>
                <div class="actions">
                    <div class="btn-group btn-group-devided" >
                        <a href="<c:url value="/hr/reports/inventoryManager"/>"  class="btn btn-transparent blue btn-outline btn-circle btn-sm active green">管理类</a>
            ...
            <div class="portlet-body">
                <div class="actions form-inline">
                    ...
                    <div class="form-group pull-right">
                        ...
                        <c:if test="${! empty reportData && currYY eq year and currMM eq month}"><button class="btn btn-sm green blue js_rebuild"><i class="fa fa-refresh"></i>重新统计</button></c:if>
                    </div>
                </div>
    ...
    $(document).ready(function () {
        ...
        $('button.js_build').on('click',function () {
            var _index = layer.confirm("确定要开始统计？",function () {
                layer.close(_index);
                build('<c:url value="/hr/reports/startStatisticsManager"/>');
            });
        });
        ...
        $('button.js_rebuild').on('click',function () {
            var _index = layer.confirm("确定要重新统计？",function () {
                layer.close(_index);
                build('<c:url value="/hr/reports/startStatisticsManager?forceStatistics=true"/>');
            });
        });

        $('button.js_search').on('click',function () {
            window.location.href='<c:url value="/hr/reports/inventoryManager/"/>'+$('input.js_ym_select').val();
        });
