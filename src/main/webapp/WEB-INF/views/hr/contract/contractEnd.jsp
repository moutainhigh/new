                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="reason">
                                ...
                                <option value="0">劳动合同期满</option>
                                <option value="1">劳动者开始依法享受基本养老保险待遇</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
    ...
    $(document).ready(function () {
        ...
        $('button.js_save').on('click',function () {
            if (validateForm.valid()){
                $.post('<c:url value="/hr/contract/postContractEnd"/>',validateForm.serialize(), function (result) {
                    if (result.success) {
