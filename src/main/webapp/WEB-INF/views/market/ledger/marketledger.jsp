...
<div class="portlet light" >
    ...
    <div class="portlet-body">
        ...
        <%--<div class="actions form-inline pull-right">
            &lt;%&ndash;<div class="form-group"><button class="btn btn-sm blue js_add">新增</button></div>&ndash;%&gt;
        </div>--%>
        <label></label>
        <div class="row">
            <table data-toggle="table" data-height="250" class="table table-width table-striped table-bordered table-advance">
                ...
                <tbody>
                    <c:forEach items="${marketCostContract.marketCostContractSplitDetailList}" var="e" varStatus="varstatus">
                        <tr>
