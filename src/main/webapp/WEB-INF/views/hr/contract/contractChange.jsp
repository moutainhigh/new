...
<h1 class="page-title">合同变更</h1>
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">原合同信息</h3>
    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="contractType">
                                <c:if test="${entity.contractType eq 0}"><option value="0">劳动合同</option></c:if>
                                <c:if test="${entity.contractType eq 1}"><option value="1">聘用协议</option></c:if>
                                <c:if test="${entity.contractType eq 2}"><option value="2">实习协议</option></c:if>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="contractType">
                                <option value="">请选择</option>
                                <option value="0">物业合同</option>
                                <option value="1">劳动合同</option>
                                <option value="2">聘用协议</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
...
//                    required : true
        ...
        $('button.js_save').on('click',function () {
            if (validateForm.valid()){
                $.post('<c:url value="/hr/contract/postContractChange"/>',validateForm.serialize(), function (result) {
                    if (result.success) {
