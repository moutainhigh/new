                        ...
                        <table class="table table-hover table-condensed " id="treetable">
                            ...
                            <c:forEach items="${list}" var="data">
                                <tr id="${data.id}" data-id="${data.id}" data-pid="${data.parentId == 0 ? "root" : data.parentId}">
                                    <td>${data.briefName}</td>
                                    <td><c:if test="${data.projectStatus==1}">在建</c:if><c:if test="${data.projectStatus==2}">筹备</c:if><c:if test="${data.projectStatus==3}">结案</c:if></td>
                                    <td><c:if test="${data.isParent==1}">否</c:if><c:if test="${data.isParent==0}">是</c:if></td>
                                    <td><c:if test="${data.isCooperate==1}">是</c:if><c:if test="${data.isCooperate==0}">否</c:if></td>
                                    <td><c:if test="${data.systemLevel==1}">是</c:if><c:if test="${data.systemLevel==0}">否</c:if></td>
