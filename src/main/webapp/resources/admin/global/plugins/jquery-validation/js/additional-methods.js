...
!function (a) {
    ...
    !function () {
        ...
        a.validator.addMethod("chinaId", function (a, b) {
        return this.optional(b) || /^[1-9]\d{5}[1-9]\d{3}(((0[13578]|1[02])(0[1-9]|[12]\d|3[0-1]))|((0[469]|11)(0[1-9]|[12]\d|30))|(02(0[1-9]|[12]\d)))(\d{4}|\d{3}[xX])$/.test(a)
    }, "无效的身份证号码"),
