...
$(function () {
                    ...
                    dataTable: {
                        ...
                        columns:[
                            ...
                            {"data":"id","render" : function(data, type, full, meta ){
                                return   '<button class="btn btn-sm btn-outline grey-salsa"  target="_blank" data-id="'+data+'"  data-specification="'+full.specificationId+'">选择</button>';
                            }}
        ...
        $('#datatable_ajax').on('click','button',function () {
            ...
            obj.specificationId = _this.data('specification');
            ...
            obj.specification = _tr.find('td:eq(6)').text();
            obj.unit = _tr.find('td:eq(7)').text();
