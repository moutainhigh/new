        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">人力资源盘点（职级）</span>
                </div>
                <div class="actions">
                    <div class="btn-group btn-group-devided" >
                        ...
                        <a href="<c:url value="/hr/reports/inventoryDutyLv"/>"  class="btn btn-transparent blue btn-outline btn-circle btn-sm active green">职级</a>
    ...
    $(document).ready(function () {
        ...
        $('button.js_build').on('click',function () {
            var _index = layer.confirm("确定要开始统计？",function () {
                layer.close(_index);
                build('<c:url value="/hr/reports/startStatisticsDutyLevel"/>');
            });
        });
        ...
        $('button.js_rebuild').on('click',function () {
            var _index = layer.confirm("确定要重新统计？",function () {
                layer.close(_index);
                build('<c:url value="/hr/reports/startStatisticsDutyLevel?forceStatistics=true"/>');
            });
        });

        $('button.js_search').on('click',function () {
            window.location.href='<c:url value="/hr/reports/inventoryDutyLv/"/>'+$('input.js_ym_select').val();
        });
