...
<div class="portlet light">
    ...
    <div class="actions form-inline">
        ...
        <a href="<c:url value='/admin/materialPrice/materialChartTable/${id}'/>" class="btn btn-outline grey-salsa"><i class="fa fa-search"></i>图表</a>
    </div>
            ...
            var  e = function(args) {
                ...
                table.init({
                    ...
                    dataTable: {
                        ...
                        pageLength: 10,
                        ajax: {
                            url: "<c:url value="/admin/materialPrice/historyListData"/>"
                        },
                        order: [[1, "asc"]],
                        columns:[
