                        ...
                        <div class="col-md-12" style="min-height: 58%">
                            <table class="table table-width table-striped table-bordered table-advance table-hover table-checkable " id="datatable_ajax">
                                ...
                                <tr role="row" class="heading">
                                    ...
                                    <th width="4%">收货税率</th>
                                    <th width="4%">收货税额</th>
                                    <th width="4%">收货不含税金额</th>
                                    <th width="4%">收货含税金额</th>
                                    <th width="4%">入库数量</th>
                                    <th width="4%">入库单价</th>
                                    <th width="4%">税率（%）</th>
                                    <th width="4%">税额</th>
                                    <th width="4%">不含税金额</th>
                                    <th width="4%">入库含税金额</th>
                                    <th width="4%">价量来源</th>
                                    <th width="5%">备注</th>
                                </tr>
                                </thead>
        ...
        $('button.js_save_btn').on('click',function () {
            if(validateForm.valid()){
                ...
                layer.confirm("确定提交？",function (c) {
                    layer.close(c);
                    _index = layer.load(2);
                    $.post('<c:url value="/admin/inventory/toReceiveBill/saveBillReceiveInfo/2"/>', dataObj, function (result) {
                        layer.close(_index);
                        if (result.success) {
