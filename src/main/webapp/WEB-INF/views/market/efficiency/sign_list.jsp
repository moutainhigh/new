...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<c:url value="/market/efficiency/sign/get" />">项目签约信息</a>
        </li>
    </ul>
...
<div class="portlet light" id="form_wizard_1">
    <div class="portlet-title">
        <div class="caption">
            <span class="caption-subject font-green sbold uppercase">项目签约信息</span>
        </div>
    </div>
    <div class="portlet-title">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#id_transmit').on('click',function () {
            ...
            if (!b) {
                ...
                layer.closeAll();
                $.ajax({
                    url: '<c:url value="/market/efficiency/sign/put"/>',
                    type: 'POST',
                    data:data,
                    dataType: 'json',
    ...
    function search() {
        window.location.href = "<c:url value="/market/efficiency/sign/get"/>"+"?i2="+$("#id_i2").val()+"&i1="+$("#id_i1").val();
    }
