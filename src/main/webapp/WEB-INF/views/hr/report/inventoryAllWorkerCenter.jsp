        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">集团人力盘点汇总(工人类)</span>
                </div>
                <div class="actions">
                    <div class="btn-group btn-group-devided" >
                        ...
                        <a href="<c:url value="/hr/reports/inventoryAllWorkerCenter"/>"  class="btn btn-transparent blue btn-outline btn-circle btn-sm active green">集团工人类汇总</a>
...
<script>
    $(document).ready(function () {
        ...
        $('button.js_search').on('click',function () {
            window.location.href='<c:url value="/hr/reports/inventoryAllWorkerCenter/"/>'+$('input.js_ym_select').val();
        });
