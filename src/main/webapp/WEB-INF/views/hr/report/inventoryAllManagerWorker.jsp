        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">公司人力盘点汇总(合计)</span>
                </div>
                <div class="actions">
                    <div class="btn-group btn-group-devided" >
                        <a href="<c:url value="/hr/reports/inventoryAllManagerWorker"/>"  class="btn btn-transparent blue btn-outline btn-circle btn-sm active green">人力盘点汇总</a>
...
<script>
    $(document).ready(function () {
        ...
        $('a.js_data_detail').on('click',function () {
            ...
            if(!_this.data('loaded')){
                $.ajax({
                    type:'post',
                    async: false,
                    url:'<c:url value="/hr/reports/getInventoryManagerWorkerData"/>',
        ...
        $('button.js_search').on('click',function () {
            window.location.href='<c:url value="/hr/reports/inventoryAllManagerWorker/"/>'+$('input.js_ym_select').val();
        });
