...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green sbold uppercase">分项分类价格</span>
        </div>
    </div>
    <div class="portlet-body">
        <div class="actions form-inline">
            ...
            <div class="form-group">
                <input type="text"  name="mcode" class="form-control" placeholder="分项分类编码">
            </div>
            <div class="form-group">
                    ...
                    dataTable: {
                        ...
                        columns:[
                            ...
                            {"data":"id","render" : function(data, type, full, meta ){
                                var editUrl = "<c:url value='/admin/workMaterialPrice/edit/'/>"+data;
                                var cityPriceUrl = "<c:url value='/admin/workMaterialPrice/materialHistoryPrice/'/>"+data;
