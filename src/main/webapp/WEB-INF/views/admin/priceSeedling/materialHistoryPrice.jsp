...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green sbold uppercase">材料历史价格</span>
        </div>
    </div>
    <div class="actions form-inline">
        ...
        <a href="<c:url value='/admin/priceSeedlingPrice/materialChartTable/${id}'/>" class="btn btn-outline grey-salsa"><i class="fa fa-search"></i>图表</a>
    </div>
            ...
            <div class="col-md-12">
                <table class="table table-width table-striped table-bordered table-advance table-hover table-checkable " id="datatable_ajax">
                    ...
                    <tr role="row" class="heading" align="center">
                        <th  colspan="2">材料名称： ${material.name} 材料规格： ${material.specification}</th>
                    </tr>
                    <tr role="row" class="heading" align="center">
                        <th>时间</th>
                        <th >价格</th>
            ...
            var  e = function(args) {
                ...
                table.init({
                    ...
                    dataTable: {
                        ...
                        pageLength: 10,
                        ajax: {
                            url: "<c:url value="/admin/priceSeedlingPrice/historyListData"/>"
                        },
                        order: [[1, "asc"]],
                        columns:[
