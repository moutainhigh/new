...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green sbold uppercase">上下班打卡</span>
        </div>
    </div>
                ...
                dataTable: {
                    ...
                    columns : [
                        ...
                        {"data":"checkinTimeStr","render" : function(data, type, full, meta ){
                            if (full.status == 0 || full.status == "" || full.status == "undefined" || full.status == 11) {
                                return data==undefined?'':data;
                            } else if (full.status == 1) {
                                return data==undefined?'':data+"(迟到)";
                            } else if (full.status == 2) {
                                return data==undefined?'':data+"(早退)";
                            } else if (full.status == 3 || full.status == 4 || full.status == 8 || full.status == 9 || full.status == 10) {
                                return "无";
