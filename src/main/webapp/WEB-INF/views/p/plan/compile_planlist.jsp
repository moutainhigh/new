    ...
    <div class="portlet-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <c:if test="${e.isCompile eq 2&&e.sufVersions>=2}">
                                <a class="btn btn-xs blue-dark" href="<c:url value="/project/plan/planedit/"/>${e.projectId}"><i class="fa fa-gear"></i> 进度维护 </a>
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
        ...
        <div class="row">
	    	<div class="col-md-5 col-sm-5">
	    		<ly:pageSizeTag link="/project/plan/planget${ly:toString(entity,'i1,s1,dt,dtn')}" page="${page}"></ly:pageSizeTag>
	    	</div>
	    	<div class="col-md-7 col-sm-7 text-right">
                <ly:pageTag link="/project/plan/planget${ly:toString(entity,'i1,s1,dt,dtn')}&pageNo=" page="${page}"></ly:pageTag>
	    	</div>
    	</div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function search() {
        window.location.href = "<c:url value="/project/plan/planget"/>"+ "${ly:toString(entity,'pageSize,dt,dtn')}"+"&s1="+$.trim($("#id_s1").val())+"&i1="+$("#id_i1").val();
    }
