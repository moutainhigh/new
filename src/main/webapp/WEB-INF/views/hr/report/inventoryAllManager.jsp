        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">公司人力盘点汇总(管理类)</span>
                </div>
                <div class="actions">
                    <div class="btn-group btn-group-devided" >
                        ...
                        <a href="<c:url value="/hr/reports/inventoryAllManager"/>"  class="btn btn-transparent blue btn-outline btn-circle btn-sm active green">管理类汇总</a>
...
<script>
    $(document).ready(function () {
        ...
        $('a.js_data_detail').on('click',function () {
            ...
            if(!_this.data('loaded')){
                $.ajax({
                    type:'post',
                    async: false,
                    url:'<c:url value="/hr/reports/getInventoryManagerData"/>',
        ...
        $('button.js_search').on('click',function () {
            window.location.href='<c:url value="/hr/reports/inventoryAllManager/"/>'+$('input.js_ym_select').val();
        });
