...
<div class="portlet light">
    <div class="portlet-title">
        ...
        <div class="actions form-inline">
            <a href="<c:url value="/admin/material/materialEdit"/>"><button class="btn blue"><i class="fa fa-plus-circle"></i>新增</button></a>
        </div>
    </div>
...
$(function () {
                ...
                table.init({
                    ...
                    dataTable: {
                        ...
                        columns:[
                            ...
                            {"data":"id","render" : function(data, type, full, meta ){
                                var editUrl = "<c:url value='/admin/material/materialEdit/'/>"+data;
        ...
        $('#datatable_ajax').on('click','button',function () {
            ...
            layer.confirm("确定要删除该材料？",function (_index) {
                layer.close(_index);
                $.post('<c:url value="/admin/material/deleteOne"/>', {id:_id}, function (result) {
                    if (result.success) {
        ...
        $('#batchDelete').click(function () {
            ...
            layer.confirm("确定要删除这些材料？",function (_index) {
                $.post("/admin/material/delete",{"ids":ids.join(',')},function (result) {
                    layer.close(_index);
