...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green sbold uppercase">苗木类别</span>
        </div>
        <div class="actions form-inline">
            <button class="btn blue js_add_root"><i class="fa fa-plus-circle"></i>添加顶级类别</button>
        </div>
    </div>
            ...
            <div class="col-xs-12 col-md-12 col-sm-12" role="main">
                <div class="panel panel-default">
                    <div class="panel-body form-horizontal">
                        <div class="actions">
                            <div class="row">
                            <div class="col-md-4" data-toggle="popover" data-trigger="focus" data-content="请输入20位有效字符">
                                <div class="input-group ">
                                    <input type="text" id="serachvalue" class="form-control" placeholder="请输入关键字">
                                    <span class="input-group-btn">
                                        <button class="btn btn-default form-control" type="button" id="serach">查询
                                        </button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  role="form" class="js_base_form" id="catEditForm" method="post" action="<c:url value="/admin/priceSeedlingCategory/update"/>">
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabelAdd">新增类别</h4>
            </div>
            <div class="modal-body">
                <form  role="form" class="js_base_form" id="catAddForm" method="post" action="<c:url value="/admin/priceSeedlingCategory/create"/>">
...
<script>
    ...
    $(function () {
        ...
        $('a.dodel').click(function () {
            ...
            if (node && node.data('leaf') === 1){
                layer.confirm('你确定要删除吗？', {
                    ...
                    layer.close(_index);
                    $.post("/admin/priceSeedlingCategory/delete",{"id":id,"parentId":pid},function (data) {
                        if (data.success){
        ...
        $("#addModal").on('click',"button:eq(1)",function () {
            $.post("/admin/priceSeedlingCategory/create",$("#addModal").find('form').serialize(),function (data) {
                if(data.success){
                    $('#addModal').modal('hide');
