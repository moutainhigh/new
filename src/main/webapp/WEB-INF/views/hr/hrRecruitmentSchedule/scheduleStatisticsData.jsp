...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green sbold uppercase">招聘岗位进程统计</span>
        </div>
    </div>
...
<script>
    ...
    $(function () {
            ...
            var  e = function() {
                ...
                table.init({
                    ...
                    dataTable: {
                        ...
                        pageLength: 10,
                        ajax: {
                            url: "<c:url value="/hr/recruitmentSchedule/statisticsData"/>"
                        },
                        order: [[1, "asc"]],
                        columns:[
        ...
        $('button.js_download').on('click',function () {
            $('#downloadForm').remove();
            var _form = $('<form>');
            _form.attr('action','<c:url value="/hr/recruitmentSchedule/downloadStatisticsData"/>');
