...
<div class="portlet box blue-hoki">
    <div class="portlet-title">
        <div class="caption">招聘汇总(按架构层级统计)</div>
    </div>
...
<script>
    ...
    $(function () {
        ...
        $('button.js_search').on('click',function () {
            ...
            if(_startDate&&_endDate){
                ...
                $.ajax({
                    ...
                    url: '<c:url value="/admin/hr/recruitmentNeeds/statisticsDataByCompanyLevel"/>',
        ...
        var entityKey = 'companyLevel,manageGroupNum';
        ...
        $("button.js_export").on('click',function () {
            ...
            $('#exportForm').remove();
            var _form = $('<form>');
            _form.attr('action','<c:url value="/admin/hr/recruitmentNeeds/exportCompanyLevel"/>');
