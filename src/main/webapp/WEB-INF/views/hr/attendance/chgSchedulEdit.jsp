                ...
                <div class="col-md-12">
                    <form  role="form" class="js_base_form form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">已排班次</label>
                                <div class="col-md-9">
    ...
    <div class="col-md-6">
        <table class="table table-striped table-bordered  table-hover">
            ...
            <c:forEach var="s" items="${shiftList}">
                <tr>
                    <td><button type="button" class="btn js_drag" data-id="${s.id}">${s.schName}</button></td>
                    <td>${s.schName}</td>
                    <td>${s.startTime}</td>
                    <td>${s.endTime}</td>
                </tr>
...
<script type="text/javascript" src="<c:url value="/resources/admin/global/plugins/jquery-ui/jquery-ui.min.js" />"></script>
<script>

    $(function () {

        $('button.js_drag').draggable({
            helper:"clone",
            cursor: "move"
        });
        ...
        $('input[name=startDate]').datepicker({
            ...
            $('input[name=endDate]').datepicker('setStartDate',time);
            if (null!=startDate&&null!=endDate){
                buildShiftLi(startDate,endDate);
            }
        ...
        $('input[name=endDate]').datepicker({
            ...
            $('input[name=startDate]').datepicker('setEndDate',time);
            if (null!=startDate&&null!=endDate){
                buildShiftLi(startDate,endDate);
            }
        }).parent(".input-group").on("click", ".input-group-btn", function (t) {
        ...
        var buildShiftLi = function(startDate,endDate){
            var _len = Math.floor((endDate-startDate)/((24*3600*1000)))+1;
            if(_len>0){
