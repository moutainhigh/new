...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<c:url value="/project/plan/plancheckget" />">进度查看</a>
        </li>
    </ul>
</div>
...
<div class="portlet light" id="form_wizard_1">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green sbold uppercase">进度查看</span>
       	</div>
        <div class="actions">
            <label>项目名称：</label>
    ...
    <div class="portlet-body">
            ...
            <tbody>
                <c:forEach items="${page.content}" var="e" varStatus="status">
                    <tr>
                        ...
                        <td>${e.versions}</td>
                        <td>
                            <c:if test="${e.isCompile eq 2&&e.sufVersions>=2}">
                                <a class="btn btn-xs blue-dark" href="<c:url value="/project/plan/plancheckedit/"/>${e.projectId}"><i class="fa fa-gear"></i> 进度查看 </a>
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
        ...
        <div class="row">
	    	<div class="col-md-5 col-sm-5">
	    		<ly:pageSizeTag link="/project/plan/plancheckget${ly:toString(entity,'i1,s1,dt,dtn')}" page="${page}"></ly:pageSizeTag>
	    	</div>
	    	<div class="col-md-7 col-sm-7 text-right">
                <ly:pageTag link="/project/plan/plancheckget${ly:toString(entity,'i1,s1,dt,dtn')}&pageNo=" page="${page}"></ly:pageTag>
	    	</div>
    	</div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function search() {
        window.location.href = "<c:url value="/project/plan/plancheckget"/>"+ "${ly:toString(entity,'pageSize,dt,dtn')}"+"&s1="+$.trim($("#id_s1").val())+"&i1="+$("#id_i1").val();
    }
