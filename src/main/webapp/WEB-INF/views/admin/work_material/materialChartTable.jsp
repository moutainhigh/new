...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green sbold uppercase">分项分类价格趋势图</span>
        </div>
    </div>

    <div class="portlet-body">
        <div id="chartable"  style="width: 800px;height:400px"></div>
        <a type="button" class="btn default" href="<c:url value='/admin/workMaterialPrice/materialHistoryPrice/${id}'/>">返回历史价格查询</a>
        <a type="button" class="btn default" href="<c:url value='/admin/workMaterialPrice/index'/>">返回价格列表</a>
    </div>
</div>
...
<script>
    $(function () {
       ...
       $.post("/admin/workMaterialPrice/historyPriceChart",{"materialId":'${id}'},function (data) {
            var listM = data.list;
            for (var i in listM ){
