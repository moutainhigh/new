...
<div class="portlet light">
    ...
    <div class="portlet-body">
        <div id="chartable"  style="width: 100%;height:400px"></div>
    </div>
    <%--<a type="button" class="btn default" href="<c:url value='/admin/priceSeedlingPrice/historyPrice/${id}'/>">返回历史价格查询</a>--%>
    <%--<a type="button" class="btn default" href="<c:url value='/admin/priceSeedlingPrice/index'/>">返回价格列表</a>--%>
</div>
...
<script>
    $(function () {
       ...
       $.post("/admin/priceSeedlingPrice/historyPriceChart",{"materialId":'${id}'},function (data) {
            var listM = data.list;
            for (var i in listM ){
